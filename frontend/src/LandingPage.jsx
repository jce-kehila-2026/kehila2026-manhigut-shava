...
const LP = {
  he:{
    ...
    howSteps:[
      {num:"01",title:"הצטרפי והגדירי פרופיל",body:"הירשמי עם האימייל שלך, מלאי שם, מקצוע ועיר — ותוך 3 דקות תהיי חלק מהקהילה.",
  ...
  en:{
    ...
    features:[
      ...
      {title:"Networking",body:"Search members by profession and city. Send help requests."},
    ...
    howSteps:[
      {num:"01",title:"Join & Set Up Your Profile",body:"Sign up with your email, fill in your name, profession and city — in 3 minutes you're part of the community.",
      ...
      {num:"03",title:"Find Members",body:"Filter by profession, city, or name — find exactly who you need.",

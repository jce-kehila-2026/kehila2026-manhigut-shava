...
const AUTH_T = {
  he: {
    ...
    firebaseErrors: {
      ...
      "auth/missing-email":         "יש להזין כתובת דוא״ל.",
      "auth/missing-password":      "יש להזין סיסמה.",
      "auth/too-many-requests":     "יותר מדי ניסיונות. נסי שוב מאוחר יותר.",
      "auth/network-request-failed":"שגיאת רשת. בדקי את החיבור לאינטרנט.",
      "auth/user-disabled":         "חשבון זה הושבת. פני לתמיכה.",
      "auth/requires-recent-login": "יש להתחבר מחדש להמשך.",
  ...
  ar: {
    ...
    firebaseErrors: {
      ...
      "auth/missing-email":         "يرجى إدخال عنوان البريد الإلكتروني.",
      "auth/missing-password":      "يرجى إدخال كلمة المرور.",
      "auth/too-many-requests":     "محاولات كثيرة جدًا. يرجى المحاولة لاحقًا.",
      "auth/network-request-failed":"خطأ في الشبكة. يرجى التحقق من اتصالك.",
      "auth/user-disabled":         "تم تعطيل هذا الحساب. تواصلي مع الدعم.",
